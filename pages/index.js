  ...
  return (
    ...
    <IndexNavbar fixed />
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-gray-700">
                Hey, Welcome to the demo Next.Js Theme
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-gray-600">
                This is a demo theme and you can change this theme according 
                to your style and way{" "}
              </p>
              <div className="mt-12">
                <a
                  href="#"
        ...
        <img
          className="absolute top-0 b-auto right-0 pt-16 sm:w-6/12 -mt-48 sm:mt-0 w-90/12 max-h-860-px"
          src="https://tinyurl.com/yda3up9u"
          alt="..."
        />
      </section>
      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-gray-200">
              ...
              <div className="flex flex-wrap">
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-white">
                        <i className="fas fa-sitemap"></i><h3 className="text-yellow-500">//</h3>
                      </div>
                  ...
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-white">
                        <i className="fas fa-drafting-compass"></i><h3 className="text-yellow-500">//</h3>
                      </div>
                      <h6 className="text-xl mb-1 font-semibold">
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-white">
                        <i className="fas fa-newspaper"></i><h3 className="text-yellow-500">//</h3>
                      </div>
                  ...
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-white">
                        <i className="fas fa-file-alt"></i><h3 className="text-yellow-500">//</h3>
                      </div>
                      <h6 className="text-xl mb-1 font-semibold">
                        Documentation
                      </h6>
        ...
        <div className="container mx-auto overflow-hidden pb-20">
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                <i className="fas fa-sitemap text-xl"></i><h3 className="text-yellow-500">//</h3>
              </div>
              ...
              >
                View All{" "}
                <i className="fa fa-angle-double-right ml-1 leading-relaxed"></i><h3 className="text-yellow-500">//</h3>
              </a>
            </div>
            ...
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto mt-32">
              <div className="relative flex flex-col min-w-0 w-full mb-6 mt-48 md:mt-0">
                <img
                  alt="..."
                  src="https://tinyurl.com/y7u5clxd"
                  className="w-full align-middle max-w-100-px"
                />
          ...
          <div className="flex flex-wrap items-center pt-32">
            ...
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              <div className="text-gray-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                <i className="fas fa-drafting-compass text-xl"></i><h3 className="text-yellow-500">//</h3>
              </div>
              <h3 className="text-3xl mb-2 font-semibold leading-normal">
                Javascript Components
              </h3>
          ...
          <div className="items-center flex flex-wrap">
            ...
            <div className="w-full md:w-6/12 mr-auto px-4 pt-24 md:pt-0">
              <img
                ...
                src="https://tinyurl.com/ybnulawp"
              />
            </div>
          </div>
        </div>
                  ...
                  <Link href="/auth/login">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        ...
                        src="https://tinyurl.com/y78lngmn"
                      />
                    </div>
                  </Link>
                </div>
                  ...
                  <Link href="/profile">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        alt="..."
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src="https://tinyurl.com/y9ab5zr8"
                      />
                    </div>
                  </Link>
                </div>
                  ...
                  <Link href="/landing">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        alt="..."
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src="https://tinyurl.com/y7v3lqt3"
                      />
                    </div>
                  </Link>
                </div>
